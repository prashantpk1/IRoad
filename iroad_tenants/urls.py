...
from .views import (
    ...
    TenantOperationActionLogAllowedActionsView,
...
urlpatterns = [
    ...
    path(
        'operations/operation-action-log/allowed-actions/',
        TenantOperationActionLogAllowedActionsView.as_view(),
        name='tenant_operation_action_log_allowed_actions',
    ),
    path(
