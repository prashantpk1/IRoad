...
class A9PaymentCollectionSideEffectTests(SimpleTestCase):
    ...
    def _bundle(self, *, promotion_action_log_id: str = '', shipment_id: str = 'ship-1', variance_detected: bool = False):
        return SimpleNamespace(
    ...
    def test_posts_when_bundle_not_consumed_yet(self):
    ...
    def test_variance_bundle_rejected(self):
        bundle = self._bundle(variance_detected=True)
        shipment = self._shipment()
        action_log = self._action_log()
